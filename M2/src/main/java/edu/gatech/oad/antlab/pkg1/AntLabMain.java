 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint =
		  ...
		  Person1 p1 = new Person1("James Lee");
		  toPrint += p1.toString("slee863");
		  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2("Jatin Nanda");
		  toPrint += p2.toString("jnanda3");
		  //Person3 replace P3 with your name
		  //and gburdell3 with your gt id
		  Person3 p3 = new Person3("Se Yeon Kim");
		  toPrint += p3.toString("skim870");
                  //Person4 replace P4 with your name
                  //and gburdell4 with your gt id
                  Person4 p4 = new Person4("Ellie Kang");
                  toPrint += p4.toString("ekang36");
                  //Person5 replace P4 with your name
                  //and gburdell5 with your gt id
                  Person5 p5 = new Person5("Lily Lau");
                  toPrint += p5.toString("llau6");

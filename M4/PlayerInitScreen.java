...
public class PlayerInitScreen implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        comboData.add(new Race("Packer", "M4/images/MULE_Packer.png"));
        comboData.add(new Race("Spheroid", "M4/images/MULE_Spheroid.png"));
        comboData.add(new Race("Humanoid", "M4/images/MULE_Humanoid.png"));
        comboData.add(new Race("Leggite", "M4/images/MULE_Leggite.png"));
        comboData.add(new Race("Flapper", "M4/images/MULE_Flapper.png"));
        comboData.add(new Race("Bonzoid", "M4/images/MULE_Bonzoid.png"));
        comboData.add(new Race("Mechtron", "M4/images/MULE_Mechtron.png"));
        comboData.add(new Race("Gollumer", "M4/images/MULE_Gollumer.png"));
    ...
    private void handleButtonAction(ActionEvent event) throws IOException {
        ...
        if (name.getText() != null && !name.getText().isEmpty()
            ...
            if (iteration == 1 || (!isSameName
                ...
                GameManager.orderedPlayers.add(new Player(playerName, raceChosen, color));
